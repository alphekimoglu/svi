...
var dashboard = angular.module('myApp.dashboards', ['ngRoute', 'cesiLib']);
...
dashboard.controller('DashboardCtrl', ['cesiService', '$scope', '$rootScope', function(cesiService, $scope, $rootScope) {
